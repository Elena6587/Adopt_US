...
<head>
  ...
  <link rel="stylesheet" href="css/Luisiane.css">
</head>
<body>
  <h1>Lapin</h1>
  <nav class="navBar">
  ...
  <div class="card">
    <div class="card-image">
        <img src="lapin_chinchilla_blanc.jpg" alt="Chinchilla" width="350">
      </div>
      <div class="card-content">
        ...
        <p>AGE: 7 mois</p>
        <p>SEXE: FEMELLE</p>
        <button href="Adopter.php" onclick="demanderAdoption('Luisiane')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
