...
<head>
  ...
  <link rel="stylesheet" href="css/Remon.css">
</head>
<body>
  <h1>Lapin</h1>
  <nav class="navBar">
  ...
  <div class="card">
    <div class="card-image">
        <img src="lapin_garenne.jpg" alt="Lapin Garenne" width="350">
      </div>
      <div class="card-content">
        ...
        <p>AGE: 3 ans</p>
        <p>SEXE: MALE</p>
        <button href="Adopter.php" onclick="demanderAdoption('Remon')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
