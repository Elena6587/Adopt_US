...
<head>
  ...
  <link rel="stylesheet" href="css/Siamois.css"
</head>
<body>
  <div class="container">
    <h1>Chat</h1>
  ...
  <div class="card">
    <div class="card-image">
        <img src="Siamois blanc gris.jpg" alt="Siamois">
    </div>
    <div class="card-content">
        ...
        <p>TAILLE: 12,5 cm</p>
        <p>POIDS: 3,08 kg</p>
        <button href="Adopter.php" onclick="demanderAdoption('Simon')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
