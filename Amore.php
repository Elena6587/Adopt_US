...
<head>
  ...
  <link rel="stylesheet" href="css/Amore.css">
</head>
<body>
  <h1>Chien</h1>
  ...
  <div class="card">
    <div class="card-image">
        <img src="Berger Belge Malinois blond noir.jpg" alt="Berger">
    </div>
    <div class="card-content">
        ...
        <p>TAILLE: 58 cm</p>
        <p>POIDS: 32.2 kg</p>
        <button href="Adopter.php" onclick="demanderAdoption('Amore')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
