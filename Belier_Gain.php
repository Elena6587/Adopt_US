...
<head>
  ...
  <link rel="stylesheet" href="css/Fiona.css">
</head>
<body>
  <h1>Lapin</h1>
  <nav class="navBar">
  ...
  <div class="card">
    <div class="card-image">
        <img src="Lapin_belier_nain_tri.jpg" alt="Belier Gain" width="350">
      </div>
      <div class="card-content">
        ...
        <p>AGE: 10 ans</p>
        <p>SEXE: FEMELLE</p>
        <button href="Adopter.php" onclick="demanderAdoption('Fiona')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
