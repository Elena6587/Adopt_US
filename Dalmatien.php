...
<head>
  ...
  <link rel="stylesheet" href="css/Dalmatien.css">
</head>
<body>
  <h1>Chien</h1>
  ...
  <div class="card">
    <div class="card-image">
        <img src="Dalmatien.jpg" alt="Dalmatien">
    </div>
    <div class="card-content">
        <h3>Race: Dalmatien</h3>
        <h4>NOM: Amanda</h4>
        <p>AGE: 23 ans</p>
        <p>SEXE: FEMELLE</p>
        <p>TAILLE: 25 cm</p>
        <p>POIDS: 28.40 kg</p>
        <button href="Adopter.php" onclick="demanderAdoption('Amanda')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
