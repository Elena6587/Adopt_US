...
<head>
  ...
  <link rel="stylesheet" href="css/JackRu.css">
</head>
<body>
  <h1>Chien</h1>
  ...
  <div class="card">
    <div class="card-image">
        <img src="Jack Russell Terrier marron noir.jpg" alt="Jack Russell">
    </div>
    <div class="card-content">
        ...
        <p>TAILLE: 38 cm</p>
        <p>POIDS: 5,05 kg</p>
       <button href="Adopter.php" onclick="demanderAdoption('Roxanie')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
