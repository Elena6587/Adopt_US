...
<body>
  ...
  <div class="card">
    <div class="card-image">
        <img src="Basenji blanc blond ou orange.jpg" alt="Basenji"  width="30%">>
    </div>
    <div class="card-content">
        ...
        <p>TAILLE: 40 cm</p>
        <p>POIDS: 9 kg</p>
        <button href="Adopter.php" onclick="demanderAdoption('Luxe')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
