...
<head>
  ...
  <link rel="stylesheet" href="css/Eliot.css">
</head>
<body>
  <h1>Lapin</h1>
  <nav class="navBar">
  ...
  <div class="card">
    <div class="card-image">
        <img src="Lapin_nain_tete_de_lion.jpg" alt="Nain Tete De Lion" width="350">
      </div>
      <div class="card-content">
        ...
        <p>AGE: 4 mois</p>
        <p>SEXE: MALE</p>
        <button href="Adopter.php" onclick="demanderAdoption('Eliot')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
