...
<head>
  ...
  <link rel="stylesheet" href="css/Helline.css">
</head>
<body>
  <h1>Lapin</h1>
  <nav class="navBar">
  ...
  <div class="card">
    <div class="card-image">
        <img src="Lapin_nain_angora.jpg" alt="Nain Angora" width="350">
      </div>
      <div class="card-content">
        ...
        <p>AGE: 5 ans</p>
        <p>SEXE: FEMELLE</p>
        <button href="Adopter.php" onclick="demanderAdoption('Helline')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
