...
<head>
  ...
  <link rel="stylesheet" href="css/Helin.css">
</head>
<body>
  <h1>Chien</h1>
  ...
  <div class="card">
    <div class="card-image">
        <img src="Bouledogue Français blond blanc.jpg" alt="Bouledogue Français">
    </div>
    <div class="card-content">
        ...
        <p>TAILLE: 34 cm</p>
        <p>POIDS: 11.02 kg</p>
        <button href="Adopter.php" onclick="demanderAdoption('Heline')" class="button-slide">Adopter</a>
    </div>
</div>
<script>
